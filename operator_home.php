<?php
    ...
    //         $query = "INSERT INTO ticket(`destination`, `departure`, `passenger_id`, `passenger_name`, `operator_id`) VALUE('$destination','$depart','$id','$passengername','2')";
            ...
            <?php
                if(isset($_POST['update_btn'])){
                    ...
                    if(!empty($passenger_name) && !empty($destination_new)){
                        $query="UPDATE ticket SET passenger_name='$passenger_name' , destination='$destination_new' WHERE id='$ticket_id'";
    ...
    <div class="container">
        <table class ="table table-bordered">
            ...
            <tr>
                ...
                <td><a href="operator_home.php?delete=<?php echo $ticket_id; ?>" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php }}else{
